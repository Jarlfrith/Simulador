...
document.getElementById("calcular-btn").addEventListener("click", function () {
  ...
  if (
    ...
    fetch("docentes_2024_reajustado.json")
...
// ... (código de la Parte 1) ...
          ...
          var apo_mnt_b16 = Number(60948); // Corresponde a Mto Fijo ACAP
          var apo_mnt_b17 = Number(144582); // Corresponde a Mto Fijo ACAP - Avanzado|Exp 1|Exp 2
